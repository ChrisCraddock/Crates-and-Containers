...
public class TwitchContainer1Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:twitch_container_1")
	public static final Block block = null;
	@ObjectHolder("blocktesting:twitch_container_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public TwitchContainer1Block(BlocktestingModElements instance) {
		super(instance, 30);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("twitch_container_1"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("twitch_container_1");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Twitch Container 1");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("twitch_container_1");
		}
