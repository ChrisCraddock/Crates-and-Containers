...
public class BlackContainer2Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:black_container_2")
	public static final Block block = null;
	@ObjectHolder("blocktesting:black_container_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BlackContainer2Block(BlocktestingModElements instance) {
		super(instance, 34);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("black_container_2"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("black_container_2");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Black Container 2");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("black_container_2");
		}
