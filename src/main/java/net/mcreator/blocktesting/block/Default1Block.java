...
public class Default1Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:default_1")
	public static final Block block = null;
	public Default1Block(BlocktestingModElements instance) {
		super(instance, 60);
	}
