...
public class SnowyLightGreenContainer2Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:snowy_light_green_container_2")
	public static final Block block = null;
	@ObjectHolder("blocktesting:snowy_light_green_container_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SnowyLightGreenContainer2Block(BlocktestingModElements instance) {
		super(instance, 124);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(
					TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("snowy_light_green_container_2"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("snowy_light_green_container_2");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Snowy Light Green Container 2");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("snowy_light_green_container_2");
		}
