...
public class SnowyGreenContainer1Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:snowy_green_container_1")
	public static final Block block = null;
	@ObjectHolder("blocktesting:snowy_green_container_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SnowyGreenContainer1Block(BlocktestingModElements instance) {
		super(instance, 72);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("snowy_green_container_1"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("snowy_green_container_1");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Snow Green Container 1");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("snowy_green_container_1");
		}
