...
public class DefaultContainer2Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:default_container_2")
	public static final Block block = null;
	@ObjectHolder("blocktesting:default_container_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public DefaultContainer2Block(BlocktestingModElements instance) {
		super(instance, 94);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("default_container_2"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("default_container_2");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("default_container_2");
		}
