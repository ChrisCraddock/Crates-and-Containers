...
public class Default0Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:default_0")
	public static final Block block = null;
	public Default0Block(BlocktestingModElements instance) {
		super(instance, 59);
	}
