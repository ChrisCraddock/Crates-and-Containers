...
public class SnowyGreenContainer2Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:snowy_green_container_2")
	public static final Block block = null;
	@ObjectHolder("blocktesting:snowy_green_container_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SnowyGreenContainer2Block(BlocktestingModElements instance) {
		super(instance, 73);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("snowy_green_container_2"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("snowy_green_container_2");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("snowy_green_container_2");
		}
