...
public class SnowyTwitchContainer0Block extends BlocktestingModElements.ModElement {
	...
	public SnowyTwitchContainer0Block(BlocktestingModElements instance) {
		super(instance, 83);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("snowy_twitch_container_0"));
		}
	}
