...
public class SnowyPeachPurpleContainer0Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:snowy_peach_purple_container_0")
	public static final Block block = null;
	@ObjectHolder("blocktesting:snowy_peach_purple_container_0")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SnowyPeachPurpleContainer0Block(BlocktestingModElements instance) {
		super(instance, 125);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(
					TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("snowy_peach_purple_container_0"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("snowy_peach_purple_container_0");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Snowy Peach Purple Container 0");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("snowy_peach_purple_container_0");
		}
