...
public class BlackCrate0Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:black_crate_0")
	public static final Block block = null;
	public BlackCrate0Block(BlocktestingModElements instance) {
		super(instance, 9);
	}
