...
public class PurpleContainer1Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:purple_container_1")
	public static final Block block = null;
	@ObjectHolder("blocktesting:purple_container_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public PurpleContainer1Block(BlocktestingModElements instance) {
		super(instance, 108);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("purple_container_1"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("purple_container_1");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Purple Container 1");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("purple_container_1");
		}
