...
public class RedContainer2Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:red_container_2")
	public static final Block block = null;
	@ObjectHolder("blocktesting:red_container_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public RedContainer2Block(BlocktestingModElements instance) {
		super(instance, 112);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("red_container_2"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("red_container_2");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Red Container 2");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("red_container_2");
		}
