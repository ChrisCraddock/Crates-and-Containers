...
public class Default2Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:default_2")
	public static final Block block = null;
	public Default2Block(BlocktestingModElements instance) {
		super(instance, 61);
	}
