...
public class SnowyTwitchContainer1Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:snowy_twitch_container_1")
	public static final Block block = null;
	@ObjectHolder("blocktesting:snowy_twitch_container_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SnowyTwitchContainer1Block(BlocktestingModElements instance) {
		super(instance, 84);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("snowy_twitch_container_1"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("snowy_twitch_container_1");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("snowy_twitch_container_1");
		}
