...
public class OrangeContainer2Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:orange_container_2")
	public static final Block block = null;
	@ObjectHolder("blocktesting:orange_container_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public OrangeContainer2Block(BlocktestingModElements instance) {
		super(instance, 37);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("orange_container_2"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("orange_container_2");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Orange Container 2");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("orange_container_2");
		}
