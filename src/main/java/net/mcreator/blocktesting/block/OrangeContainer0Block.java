...
public class OrangeContainer0Block extends BlocktestingModElements.ModElement {
	@ObjectHolder("blocktesting:orange_container_0")
	public static final Block block = null;
	@ObjectHolder("blocktesting:orange_container_0")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public OrangeContainer0Block(BlocktestingModElements instance) {
		super(instance, 35);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("orange_container_0"));
		}
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("orange_container_0");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Orange Container 0");
					}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("orange_container_0");
		}
