...
@OnlyIn(Dist.CLIENT)
public class WhiteContainerEndsGUIGuiWindow extends ContainerScreen<WhiteContainerEndsGUIGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = WhiteContainerEndsGUIGui.guistate;
	public WhiteContainerEndsGUIGuiWindow(WhiteContainerEndsGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
