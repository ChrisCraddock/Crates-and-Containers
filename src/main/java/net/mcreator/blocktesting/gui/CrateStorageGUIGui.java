...
public class CrateStorageGUIGui extends BlocktestingModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public CrateStorageGUIGui(BlocktestingModElements instance) {
		super(instance, 199);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("crate_storage_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, CrateStorageGUIGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(27, this.addSlot(new SlotItemHandler(internal, 27, 7, 8) {
			}));
			this.customSlots.put(28, this.addSlot(new SlotItemHandler(internal, 28, 25, 8) {
			}));
			this.customSlots.put(29, this.addSlot(new SlotItemHandler(internal, 29, 43, 8) {
			}));
			this.customSlots.put(30, this.addSlot(new SlotItemHandler(internal, 30, 115, 8) {
			}));
			this.customSlots.put(31, this.addSlot(new SlotItemHandler(internal, 31, 133, 8) {
			}));
			this.customSlots.put(32, this.addSlot(new SlotItemHandler(internal, 32, 151, 8) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
		...
		public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
			...
			if (slot != null && slot.getHasStack()) {
				...
				if (index < 33) {
					if (!this.mergeItemStack(itemstack1, 33, this.inventorySlots.size(), true)) {
						return ItemStack.EMPTY;
					}
					slot.onSlotChange(itemstack1, itemstack);
				} else if (!this.mergeItemStack(itemstack1, 0, 33, false)) {
					if (index < 33 + 27) {
						if (!this.mergeItemStack(itemstack1, 33 + 27, this.inventorySlots.size(), true)) {
							return ItemStack.EMPTY;
						}
					} else {
						if (!this.mergeItemStack(itemstack1, 33, 33 + 27, false)) {
							return ItemStack.EMPTY;
						}
					}
					return ItemStack.EMPTY;
