...
public class ClearCraftingItemsAfterTaking9Procedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				BlocktestingMod.LOGGER.warn("Failed to load dependency entity for procedure ClearCraftingItemsAfterTaking9!");
			return;
		}
