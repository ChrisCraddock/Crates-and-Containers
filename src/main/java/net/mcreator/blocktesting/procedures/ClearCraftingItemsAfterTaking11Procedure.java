...
public class ClearCraftingItemsAfterTaking11Procedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				BlocktestingMod.LOGGER.warn("Failed to load dependency entity for procedure ClearCraftingItemsAfterTaking11!");
			return;
		}
